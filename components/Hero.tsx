    ...
    return (
        <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
            ...
            <p className="regular-16 mt-16 text-gray-30 xl:max-w-[520px]">
                We want to be on each of your journeys seeking the statisfaction of seeing the incorruptible beauty of nature.
                We can help help you on an adventure around the world in just one app.
            </p>
